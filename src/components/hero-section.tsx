                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">All In one tool Directory</span>
                                ...
                                <TextEffect
                                    ...
                                    Toolspick - All tool in one place
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link href="#link">
                                            <span className="text-nowrap">Submit Your Tool</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
